...
//			System.out.println(field_view);
			...
			RequestDispatcher dis = request.getRequestDispatcher("/bbs/view.jsp?code="+code+"&uid="+uid+"&tb_id="+id+"&pageNum="+pageNum+"&field_view="+field_view+"&search_view="+search_view+"");
