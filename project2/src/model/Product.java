...
public class Product {
	...
	public String toString() {
		return "Product [uid=" + uid + ", id=" + id + ", subject=" + subject + ", comment=" + comment + ", category="
				+ category + ", p_name1=" + p_name1 + ", price1=" + price1 + ", number1=" + number1 + ", p_name2="
				+ p_name2 + ", price2=" + price2 + ", number2=" + number2 + ", p_name3=" + p_name3 + ", price3="
				+ price3 + ", number3=" + number3 + ", baesong=" + baesong + ", baesong_free=" + baesong_free
				+ ", gongji=" + gongji + ", file1_o=" + file1_o + ", file1_s=" + file1_s + ", file2_o=" + file2_o
				+ ", file3_o=" + file3_o + ", account_name=" + account_name + ", account_num=" + account_num
				+ ", zipcode=" + zipcode + ", zip1=" + zip1 + ", zip2=" + zip2 + ", zip3=" + zip3 + ", signdate="
				+ signdate + ", review_num=" + review_num + "]";
	}
