...
<div style="clear: both;">
	<div>회원수정</div>
	<div>
		<div>이메일<input name="mail1" id="mail1" value="${M.mail1}">@<input name="mail2" id="mail2" value="${M.mail2}">
		...
		<div>번호<input type="text" id="sample6_postcode" placeholder="우편번호" name="zipcode" value="${M.zipcode}"><input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"></div>
		<div>
			주소
		...
		<div>참고사항<input type="text" id="sample6_extraAddress" placeholder="참고항목" name="zip3" value="${M.zip3}"></div>	
