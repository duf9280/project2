...
<section>
	...
	<div style="margin:0 auto; width:900px; display:flex;">
		...
		<form action="lecturewrite.do" method="post" enctype="multipart/form-data">
		...
		<div style="margin:0 auto; width:800px; border-bottom:1px solid gray; display:flex; flex-direction:column; align-items:center;">
			...
			<div style="display:flex; justify-content:space-between; align-items:center; width:800px;">
				...
				<div>상품1 [필수]
					<div class="product_write">
						<div>상품이름1</div>
						<div>
							<input name="p_name1" id="p_name1" required>
						</div>
						<div>가격1</div>
						<div>
							<input name="price1" id="price1" placeholder="숫자입력" required>
						</div>
						<div>판매수량1</div>
						<div>
							<input name="number1" id="number1" placeholder="숫자입력" required>
						</div>
					</div>
				</div>
				<div>상품2
					<div class="product_write">
						<div>상품이름2</div>
						<div>
							<input name="p_name2" id="p_name2">
						</div>
						<div>가격2</div>
						<div>
							<input name="price2" id="price2" placeholder="숫자입력" value="0">
						</div>
						<div>판매수량2</div>
						<div>
							<input name="number2" id="number2" placeholder="숫자입력" value="0">
						</div>
					</div>
					<div>
			...
			<div style="margin:0 auto; width:800px; display:flex; justify-content:space-between;">
				<div><a href="list.jsp?code=<%=code%>&category=${param.category}&pageNum=${pageNum}">[목록]</a></div>
				<div><button>[강의등록]</button></div>
			</div>
		</div>
		</form>
	</div>
